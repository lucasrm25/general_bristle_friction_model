...
p2=plot(out_sim_m0p01.simlog.dot_rt.f.series.time, -out_sim_m0p01.simlog.dot_rt.f.series.values, 'DisplayName', '$f_t$ $(m_b=0.01)$');
p3=plot(out_sim_m0p10.simlog.dot_rt.f.series.time, -out_sim_m0p10.simlog.dot_rt.f.series.values, 'DisplayName', '$f_t$ $(m_b=0.10)$');
p4=plot( ...
    out_sim_m0p00.simlog.Dynamic_Friction.stick.series.time, ...
    1-out_sim_m0p00.simlog.Dynamic_Friction.stick.series.values, ...
    'DisplayName', 'slip', ...
    'Color', 'black','LineStyle','--' ...
);
p5=plot( ...
    out_sim_m0p01.simlog.Dynamic_Friction.stick.series.time, ...
    1-out_sim_m0p01.simlog.Dynamic_Friction.stick.series.values, ...
    'DisplayName', 'slip', ...
    'Color', 'black','LineStyle','--' ...
);
p6=plot( ...
    out_sim_m0p10.simlog.Dynamic_Friction.stick.series.time, ...
    1-out_sim_m0p10.simlog.Dynamic_Friction.stick.series.values, ...
    'DisplayName', 'slip', ...
    'Color', 'black','LineStyle','--' ...
);
...
plot(out_sim_m0p00.simlog.Dynamic_Friction.f.series.time, out_sim_m0p00.simlog.Dynamic_Friction.f.series.values, 'DisplayName', '$\dot f_\mu$ $(m_b=0.00)$')
plot(out_sim_m0p01.simlog.Dynamic_Friction.f.series.time, out_sim_m0p01.simlog.Dynamic_Friction.f.series.values, 'DisplayName', '$\dot f_\mu$ $(m_b=0.01)$')
plot(out_sim_m0p10.simlog.Dynamic_Friction.f.series.time, out_sim_m0p10.simlog.Dynamic_Friction.f.series.values, 'DisplayName', '$\dot f_\mu$ $(m_b=0.10)$')
xlabel('Time [s]', 'Interpreter','latex')
...
p2 = plot(out_sim_m0p01.simlog.Bristle_Mass.v.series.time, out_sim_m0p01.simlog.Bristle_Mass.v.series.values, 'DisplayName', '$\dot r_b$ $(m_b=0.01)$');
